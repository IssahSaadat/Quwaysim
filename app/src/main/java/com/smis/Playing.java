...
public class Playing extends AppCompatActivity implements View.OnClickListener {
    ...
    final static long TIMEOUT = 1000000;
    int progressValue = 0;
    CountDownTimer mCountDown;
    int index = 0, score = 0, thisQuestion = 0, totalQuestion = 0, correctAnwer;
    ...
    protected void onResume() {
        ...
        Toast.makeText(this, "Total: " + totalQuestion, Toast.LENGTH_LONG).show();
