...
//                    FirebaseStorage.getInstance().getReference().child("images/users/profile_image").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
//                        @Override
//                        public void onSuccess(Uri uri) {
//                            Log.d(TAG, "get url successful");
//                            downloadUrl = uri.toString();
//                        }
//                    }).addOnFailureListener(new OnFailureListener() {
//                        @Override
//                        public void onFailure(@NonNull Exception e) {
//                            Log.d(TAG, "get Url Failed");
//                        }
//                    });
                    try {
...
//            for (int i = 1; i < 11; i++) {
//                if (i == 10) {
//                    Toast.makeText(SettingsActivity.this, "The Image is too large", Toast.LENGTH_SHORT).show();
//                    break;
//                }
